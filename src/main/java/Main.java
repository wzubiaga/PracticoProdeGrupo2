...
public class Main {
    public static void main(String[] args)throws IOException {
        ...
        ArrayList<Partido> importarR = ImportadorDeResultados.GetResultadosFromFile("src/main/resources/resultados.csv", equiposParticipantes);
        ...
        ArrayList<Pronostico> importarP = ImportadorDeResultados.GetPronosticoFromFile("src/main/resources/pronostico.csv", equiposParticipantes, primeraRonda);
